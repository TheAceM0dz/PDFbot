...
def converter_arquivo():
    ...
    ui.print_info(ui.t("msg_extensao_detectada", ext=extensao))
...
def converter_lote():
    ...
    ui.print_info(ui.t("msg_lote_encontrados", n=len(arquivos)))
...
def menu():
    while True:
        ...
        if escolha == "converter":
            ...
            ui.console.print(f"\n[bold magenta]{ui.t('msg_ate_mais')}[/bold magenta]\n")
            break
